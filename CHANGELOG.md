...
- Web: collapse expanded task when clicking outside the card; row switching and portaled pickers preserved; Playwright e2e.

## [0.3.5] - 2026-03-22

- Shipped via Actions Release: explicit Docker + Desktop dispatch and GitHub Release assets. README uses semver tag badge (see docs/releasing.md).
...
- Web: date popover calendar stays inside panel (fixed table layout, selected-day typography).
...
[Unreleased]: https://github.com/OpenClaudeAgent/BlueTasks/compare/v0.3.6...HEAD
