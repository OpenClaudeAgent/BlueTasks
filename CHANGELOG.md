...
- Scenario: table-driven Lexical toolbar ([`editor-toolbar-helpers.ts`](scenario/editor-toolbar-helpers.ts)); [`api.production.spec.ts`](scenario/api.production.spec.ts) uses [`api-production-helpers.ts`](scenario/api-production-helpers.ts) + parametrized GET/404 cases; new [`settings-export.spec.ts`](scenario/settings-export.spec.ts) (export filename + SQLite header).
...
[Unreleased]: https://github.com/OpenClaudeAgent/BlueTasks/compare/v0.2.2...HEAD
