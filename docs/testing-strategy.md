...
- **Scenario tests (browser)**: Playwright under [`scenario/`](../scenario/) — [`api.production.spec.ts`](../scenario/api.production.spec.ts) (HTTP against the live build; shared JSON helpers in [`api-production-helpers.ts`](../scenario/api-production-helpers.ts)), [`app-shell.spec.ts`](../scenario/app-shell.spec.ts) (initial load, SPA fallback), [`task-lifecycle.spec.ts`](../scenario/task-lifecycle.spec.ts) (tasks UI), [`navigation-settings.spec.ts`](../scenario/navigation-settings.spec.ts), [`settings-export.spec.ts`](../scenario/settings-export.spec.ts) (SQLite export download + filename / magic bytes), [`editor-toolbar.spec.ts`](../scenario/editor-toolbar.spec.ts) (Lexical toolbar — table-driven simple formats in [`editor-toolbar-helpers.ts`](../scenario/editor-toolbar-helpers.ts), plus list/table/markdown cases in the spec); shared helpers [`scenario/helpers.ts`](../scenario/helpers.ts), [`scenario/api-helpers.ts`](../scenario/api-helpers.ts), [`scenario/task-flow-helpers.ts`](../scenario/task-flow-helpers.ts) (see [`playwright.config.ts`](../playwright.config.ts)). Further specs cover estimates, recurrence, timer, areas, settings, language/import, quick capture, Upcoming, and filters.
